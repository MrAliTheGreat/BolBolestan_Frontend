...
export default class Courses extends React.Component{
    ...
    handleSearchOfferingFetch = async (event) => {
        const serverData = await AxiosWithHeader.get(`http://87.247.185.122:31007/courses/offers`);
    ...
    handleOfferingsNameFetch = async (event) => {
        const serverData = await AxiosWithHeader.get(`http://87.247.185.122:31007/courses/offersNames`);
        const jsonData = serverData.data;
        this.setState({
    ...
    handleSelectedNowOffersFetch = async (event) => {
        const serverData = await AxiosWithHeader.get(`http://87.247.185.122:31007/courses/selectedNowOffers`);
        const jsonData = serverData.data;
        this.setState({
    ...
    handleSelectedNowOffersStatusFetch = async (event) => {
        const serverData = await AxiosWithHeader.get(`http://87.247.185.122:31007/courses/selectedNowOffersStatus`);
        const jsonData = serverData.data;
        this.setState({
    ...
    handleNumUnitsSelectedNowOffersFetch = async (event) => {
        const serverData = await AxiosWithHeader.get(`http://87.247.185.122:31007/courses/numSelectedNowOffersUnits`);
        const jsonData = serverData.data;
        this.setState({
    ...
    async searchForOffersByName(event , searchText){
        ...
        let response = await AxiosWithHeader.post("http://87.247.185.122:31007/courses/searchName" , {
    ...
    async searchForOffersByType(searchType){
        ...
        let response = await AxiosWithHeader.post("http://87.247.185.122:31007/courses/searchType" , {
    ...
    async addToSelectedNowOffers(offerCode , offerClassCode){
        ...
        let response = await AxiosWithHeader.post(`http://87.247.185.122:31007/courses/add` , {
            offerCode: offerCode ,
    ...
    async removeFromSelectedNowOffers(offerCode , offerClassCode){
        ...
        let response = await AxiosWithHeader.delete(`http://87.247.185.122:31007/courses/remove` , { data:
            {
                offerCode: offerCode,
                offerClassCode: offerClassCode
            }
    ...
    async handleResetSelectedNowOffers(event){
        ...
        let response = await AxiosWithHeader.post(`http://87.247.185.122:31007/courses/reset` , {
            reset: "reset"
        });
        if(response.data === "OK"){
            this.handleSelectedNowOffersFetch();
    ...
    async handleSubmit(event){
        ...
        let response = await AxiosWithHeader.post(`http://87.247.185.122:31007/courses/submit` , {
            submit: "submit"
        });;
        if(response.data === "OK"){
            this.handleSearchOfferingFetch();
