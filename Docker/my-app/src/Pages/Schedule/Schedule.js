...
export default class Schedule extends React.Component{
    ...
    async handleStudentCoursesFetch(){
        const serverData = await AxiosWithHeader.get(`http://localhost:8080/schedule/JWT`);
    ...
    async handleSemesterNumberFetch(){
        const serverData = await AxiosWithHeader.get(`http://localhost:8080/schedule/currentTerm`);
        const jsonData = serverData.data;
        this.setState({
